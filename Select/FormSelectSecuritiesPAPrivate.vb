...
Public Class FormSelectSecuritiesPAPrivate
    ...
    Public Sub SecuritiesLoad()
        ...
        Dim objInstrument As New PrivateInstrumentPhysicalAsset
        objInstrument.Clear()
        objInstrument.UserAccess = objAccess
        tbl = objInstrument.Search(objMasterSimpi, txtKeyword.Text, cmbCountry.SelectedValue,
                                   IIf(cmbSubType.SelectedIndex = -1, 0, cmbSubType.SelectedValue), 0, 0)
        If objInstrument.ErrID = 0 Then
            tbl2 = tbl.DefaultView.ToTable("company", True, "SecuritiesID", "SecuritiesCode",
            ...
            With DBGInstrument
                ...
                Dim ID, Code, Name, Issue, Ccy, SubType, Status As C1DisplayColumn
