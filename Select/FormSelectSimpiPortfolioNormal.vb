...
Public Class FormSelectSimpiPortfolioNormal
    ...
    Private Sub FormSelectSimpiPortfolio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lblSimpiType.Text = objMasterSimpi.GetSimpiType.GetTypeCode
        lblSimpiStatus.Text = objMasterSimpi.GetSimpiStatus.GetStatusCode
        GetParameterCountry()
    ...
    Private Sub txtKeyword_KeyDown(sender As Object, e As KeyEventArgs) Handles txtKeyword.KeyDown
        If e.KeyCode = Keys.Enter Then PortfolioSearch()
    End Sub
    ...
    Private Sub PortfolioSearch()
        ...
        dtPortfolio = objPortfolio.Search(objMasterSimpi, strKeyword, SetPortfolio)
