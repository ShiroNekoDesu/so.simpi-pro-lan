...
Imports simpi.ParameterPortfolio.ParameterPortfolio

Public Class FormSelectMasterPortfolioNormalSubFOF
    ...
    Private Sub PortfolioSearch()
        ...
        If objPortfolio.ErrID = 0 Then
            Dim query = From p In dtPortfolio.AsEnumerable
                        ...
                        Join a In dtParameterPortfolioAsset.AsEnumerable On
                                  p.Field(Of Integer)("AssetTypeID") Equals a.Field(Of Integer)("AssetTypeID")
                        Join t In dtParameterPortfolioType.AsEnumerable On
                                  p.Field(Of Integer)("TypeID") Equals t.Field(Of Integer)("TypeID")
                        Where p.Field(Of Integer)("TypeID") = SetPortfolio() Or
                              p.Field(Of Integer)("TypeID") = SetSubPortfolio() Or
                              p.Field(Of Integer)("TypeID") = SetFundOnFund()
                        Select
