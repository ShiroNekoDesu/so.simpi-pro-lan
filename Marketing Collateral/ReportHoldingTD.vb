...
Public Class ReportHoldingTD
    ...
    Private Sub DataLoad()
        ...
        objAccount.Clear()
        dtAccount = objAccount.SearchAll(objMasterSimpi)
        objNAV.Clear()
    ...
    Private Sub displayTDCcy()
        If dtPosition IsNot Nothing AndAlso dtPosition.Rows.Count > 0 AndAlso
            ...
            Dim query = From s In dtPosition.AsEnumerable
                        ...
                        Join p In dtPortfolioMaster.AsEnumerable On p.Field(Of Integer)("PortfolioID") Equals a.Field(Of Integer)("PortfolioID")
...
#Region "bank"
    ...
    Private Sub displayBankCcy1()
        If dtPosition IsNot Nothing AndAlso dtPosition.Rows.Count > 0 AndAlso
           dtAccount IsNot Nothing AndAlso dtAccount.Rows.Count > 0 AndAlso cmbCcy.SelectedIndex <> -1 Then
            Dim nav As Double = (From n In dtNAV.AsEnumerable Join p In dtPortfolioMaster.AsEnumerable
