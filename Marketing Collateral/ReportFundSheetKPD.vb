        ...
        If lblPortfolioCode.Text.Trim <> "" Then
            ...
            If objSimpi.ErrID = 0 Then
                ...
                If objPortfolio.ErrID = 0 Then
                    ...
                    txtBestMonth.Text = IIf(tmp.Trim = "", "-", tmp.Trim)
                    ...
                    txtTotalReturn.Text = IIf(tmp.Trim = "", "-", tmp.Trim)
...
#Region "export"
    ...
    Private Function PrintPDF(ByVal isAttachment As Boolean) As String
        ...
        With c1pdf
            ...
            koordY += 13
            If txtTotalReturn.Text.Contains("<3") Then
                .FillRectangle(periodBr1, New Rectangle(koordX + 45, koordY, 80, fontSize + 2))
                .DrawString(txtTotalReturn.Text, New Font(fontType, fontSize), Brushes.WhiteSmoke, New Rectangle(koordX + 45, koordY, 80, fontSize + 2), sf)
            ElseIf txtTotalReturn.Text.Contains("3-5") Then
                .FillRectangle(periodBr2, New Rectangle(koordX + 40, koordY, 80, fontSize + 2))
                .DrawString(txtTotalReturn.Text, New Font(fontType, fontSize), Brushes.WhiteSmoke, New Rectangle(koordX + 40, koordY, 80, fontSize + 2), sf)
            ElseIf txtTotalReturn.Text.Contains(">5") Then
            ...
            koordY += 13
            If txtBestMonth.Text.Contains("VERY KONSERVATIF") Then
                .FillRectangle(riskBr1, New Rectangle(koordX + 50, koordY, 80, fontSize + 2))
                .DrawString(txtBestMonth.Text, New Font(fontType, fontSize), Brushes.WhiteSmoke, New Rectangle(koordX + 50, koordY, 80, fontSize + 2), sf)
            ElseIf txtBestMonth.Text.Contains("KONSERVATIF") Then
                .FillRectangle(riskBr2, New Rectangle(koordX + 70, koordY, 50, fontSize + 2))
                .DrawString(txtBestMonth.Text, New Font(fontType, fontSize), Brushes.WhiteSmoke, New Rectangle(koordX + 70, koordY, 50, fontSize + 2), sf)
            ElseIf txtBestMonth.Text.Contains("MODERAT") Then
                .FillRectangle(riskBr3, New Rectangle(koordX + 70, koordY, 50, fontSize + 2))
                .DrawString(txtBestMonth.Text, New Font(fontType, fontSize), Brushes.WhiteSmoke, New Rectangle(koordX + 70, koordY, 50, fontSize + 2), sf)
            ElseIf txtBestMonth.Text.Contains("AGRESIF") Then
                .FillRectangle(riskBr4, New Rectangle(koordX + 70, koordY, 50, fontSize + 2))
                .DrawString(txtBestMonth.Text, New Font(fontType, fontSize), Brushes.WhiteSmoke, New Rectangle(koordX + 70, koordY, 50, fontSize + 2), sf)
            ElseIf txtBestMonth.Text.Contains("VERY AGRESIF") Then
