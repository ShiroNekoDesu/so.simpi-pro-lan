...
Public Class FormMasterPortfolioBenchmark
    ...
    Private Sub CodesetLoad()
        ...
        If dtParameterPortfolioCodeset IsNot Nothing AndAlso dtParameterPortfolioCodeset.Rows.Count > 0 Then
            Dim query = From c In dtParameterPortfolioCodeset.AsEnumerable
                        Group Join f In dtField.AsEnumerable
                            On c.Field(Of Integer)("FieldID") Equals f.Field(Of Integer)("FieldID")
                            Into cf = Group Let f = cf.FirstOrDefault
                        Select
...
#Region "sharing user"
    ...
    Private Sub txtKeywordUserSharing_KeyDown(sender As Object, e As KeyEventArgs) Handles txtKeywordUserSharing.KeyDown
        If e.KeyCode = Keys.Enter Then
            UserSharingSearch()
        End If
    End Sub
    ...
    Private Sub btnRemoveUserSharing_Click_1(sender As Object, e As EventArgs) Handles btnRemoveUserSharing.Click
        UserSharingRemove()
    End Sub
