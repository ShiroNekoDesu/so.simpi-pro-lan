...
Public Class FormMasterPortfolioAddSharing
    ...
    Public Sub UserSearch()
        If txtKeyword.Text.Trim <> "" Then
            ...
            tbl = objPortfolio.User_SearchSharingAdminAvailable(strKeyword)
            ...
            End If
        Else
            ExceptionMessage.Show(objError.Message(107), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
