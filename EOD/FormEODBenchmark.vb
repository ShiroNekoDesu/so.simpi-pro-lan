...
Public Class FormEODBenchmark
    ...
    Private Sub FormEODBenchmark_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub BenchmarkLoad()
        ...
        If objPortfolio.ErrID = 0 Then
            If dtPortfolio.Rows.Count > 0 Then
                ...
                dtBenchmark = objBenchmark.Search(PortfolioID, dtValuation.Value)
                ...
                Dim query3 = From q In query2 Group Join r In dtBenchmark.AsEnumerable
                ...
                With DBGPortfolio
                    ...
                    .Columns("rDate").Caption = "Benchmark"
    ...
    Private Sub NAVLoad()
        With DBGPortfolio
            If .RowCount > 0 Then
                ...
                If objPortfolio.ErrID = 0 Then
                    objBenchmark.Clear()
                    objBenchmark.LoadAt(objPortfolio, dtValuation.Value)
                    If objNAV.ErrID = 0 Then
                        Dim form As New FormEODBenchmarkProfile
                        If IsMdiChild Then
                            form.MdiParent = MDISO
                        End If
                        form.objPortfolio = objPortfolio
                        form.objPosition = objBenchmark
                        form.FormLoad()
                        form.CallerForm = Me
                        form.Show()
                    Else
