...
Public Class FormEODFundOnFund
    ...
    Public Sub MTMLoad()
        ...
        objPortfolio.Clear()
        dtPortfolio = objPortfolio.Search(txtKeyword.Text.Trim, 9, 0, 0, 0, CcyID)
    ...
    Private Sub ClosingLoad()
        With DBGPortfolio
            If .RowCount > 0 Then
                ...
                If objPortfolio.ErrID = 0 Then
                    Dim form As New FormEODFundOnFundProfile
                    If IsMdiChild Then form.MdiParent = MDISO
                    form.objFoF = objPortfolio
                    form.navDate = dtValuation.Value
                    form.FormLoad()
                    form.CallerForm = Me
                    form.Show()
                Else
