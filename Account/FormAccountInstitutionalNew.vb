...
Public Class FormAccountInstitutionalNew
...
#Region "risk profile"
    ...
    Private Sub DBGRisk_Click(sender As Object, e As EventArgs) Handles DBGRisk.Click
        If DBGRisk.RowCount > 0 Then DBGRisk.MarqueeStyle = MarqueeEnum.HighlightRow
    End Sub
...
#Region "kyc"
    ...
    Private Sub DBGKYC_Click(sender As Object, e As EventArgs) Handles DBGKYC.Click
        If DBGKYC.RowCount > 0 Then DBGKYC.MarqueeStyle = MarqueeEnum.HighlightRow
    End Sub
    ...
    Private Sub DBGKYCAnswer_Click(sender As Object, e As EventArgs) Handles DBGKYCAnswer.Click
        If DBGKYCAnswer.RowCount > 0 Then DBGKYCAnswer.MarqueeStyle = MarqueeEnum.HighlightRow
    End Sub
