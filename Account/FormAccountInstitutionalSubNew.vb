...
Public Class FormAccountInstitutionalSubNew
    Public CallerForm As FormAccountInstitutionalProfile
    Public objParent As simpi.MasterClient.MasterClientInstitution
    Dim objClient As New simpi.MasterClient.MasterClientInstitutionSub
    Dim objMasterClient As New simpi.MasterClient.MasterClient
    Dim objKYC As New SimpiKYC
    Dim objRisk As New SimpiRiskLevel
    Dim tblRisk As New DataTable
    Dim tblKYC As New DataTable
    Dim objClientKYC As New simpi.MasterClient.ClientKYC
    Dim objClientRisk As New simpi.MasterClient.ClientQuestioner
    ...
    Private Sub ClientName()
        If txtSubSeparator.Text.Trim = "" Then
            lblNameSub.Text = lblName.Text.Trim & " " & txtSubName.Text.Trim
        Else
...
#Region "save"
    ...
    Private Sub DataSave()
        If _check() Then
            objClient.Clear()
            objClient.Add(objParent, objParent.GetMasterSales, lblNameSub.Text, cmbValuation.SelectedValue,
                          cmbXRate.SelectedValue, IIf(rbLocal.Checked, "L"c, "F"c), txtSignatureRule.Text,
    ...
    Private Sub _saveBank()
        Dim objBank As New simpi.MasterClient.ClientBankAccount
