...
Public Class FormAccountInstitutionalProfile
    ...
    Private Sub ClientEdit()
        Dim frm As New FormAccountInstitutionalEdit
        frm.Show()
...
#Region "bank account"
    ...
    Private Sub BankAdd()
        If txtBankName.Text.Trim <> "" And txtAccountNo.Text.Trim <> "" And cmbAccountCcy.SelectedIndex <> -1 Then
            objBank.Add(objMasterClient, txtBankName.Text, txtBankBranch.Text,
    ...
    Private Sub BankRemove()
        objBank.Remove(objMasterClient, txtBankName.Text, txtAccountNo.Text)
        If objBank.ErrID = 0 Then
            BankLoad()
        Else
            ExceptionMessage.Show(objBank.ErrMsg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
...
#Region "risk"
    Private Sub RiskLoad()
        ...
        Dim tbl As New DataTable
        tbl = objClientRisk.Answer_Search()
...
#Region "sub account"
    ...
    Public Sub SubAccountSearch()
        ...
        objSub.Clear()
        dtClient = objSub.Search(objClient, txtKeywordSubAccount.Text)
    ...
    Private Sub SubAccountAdd()
        Dim frm As New FormAccountInstitutionalSubNew
        frm.CallerForm = Me
    ...
    Private Sub SubAccountProfile()
        With DBGSubAccount
            If .RowCount > 0 Then
                ...
                Dim frm As New FormAccountInstitutionalSubProfile
                frm.Show()
