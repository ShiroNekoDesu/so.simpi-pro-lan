...
Public Class FormAccountIndividualSubNew
    Public CallerForm As FormAccountIndividualProfile
    ...
    Private Sub chkSeparateAccount_CheckedChanged(sender As Object, e As EventArgs) Handles chkSeparateAccount.CheckedChanged
        If chkSeparateAccount.Checked Then chkSeparateAccount.Text = "Y" Else chkSeparateAccount.Text = "N"
    End Sub
    ...
    Private Sub DataSave()
        If _check() Then
            objClient.Clear()
            objClient.Add(objParent, objParent.GetMasterSales, lblNameSub.Text, txtSubName.Text, txtSubSeparator.Text, chkSeparateAccount.Text)
