...
Public Class FormAccountIndividualProfile
    ...
    Private Sub ClientEdit()
        Dim frm As New FormAccountIndividualEdit
        frm.Show()
...
#Region "sub account"
    ...
    Private Sub SubAccountAdd()
        Dim frm As New FormAccountIndividualSubNew
        frm.CallerForm = Me
    ...
    Private Sub SubAccountProfile()
        With DBGSubAccount
            If .RowCount > 0 Then
                ...
                Dim frm As New FormAccountIndividualSubProfile
                frm.Show()
