...
Public Class FormTransactionDividendCash
    ...
    '    Private Sub FormTransactionSubscription_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    '        GetMasterSimpi()
    '        objPortfolio.UserAccess = objAccess
    '        objNAV.UserAccess = objAccess
    '        objCapital.UserAccess = objAccess
    '        objTrx.UserAccess = objAccess
    '        DBGSubscription.FetchRowStyles = True
    '        dtFrom.Value = Now.AddDays(-7)
    '        dtTo.Value = Now
    '    End Sub
    ...
    '                End With
    '            Else
    '                DBGSubscription.Columns.Clear()
    '                ExceptionMessage.Show(objTrx.ErrMsg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    '            End If
    '        End If
    '    End Sub

    '    Private Sub DBGSubscription_FetchRowStyle(sender As Object, e As FetchRowStyleEventArgs) Handles DBGSubscription.FetchRowStyle
    '        If e.Row Mod 2 = 0 Then
    '            e.CellStyle.BackColor = Color.LemonChiffon
    '        End If
    '    End Sub

    '    Private Sub DBGSubscription_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DBGSubscription.Click
    '        With DBGSubscription
    '            If .RowCount > 0 Then
    ...
    '                Dim frm As New FormTransactionSubscriptionNew
    ...
    '                If objTrx.ErrID = 0 Then
    '                    Dim frm As New FormTransactionSubscriptionDelete
    '                    frm.Show()
    '                    'frm.objSubscription = objTrx
    '                    frm.SubscriptionLoad()
    '                    frm.CallerForm = Me
    '                    frm.MdiParent = MDISO
    '                Else
    '                    ExceptionMessage.Show(objTrx.ErrMsg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
