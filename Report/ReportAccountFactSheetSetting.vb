...
#Region "setting"
    Private Sub colorSet()
        If cd.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
            ...
            ElseIf rbPieTitle1.Checked Then
                txtColorPieTitle1.BackColor = cd.Color
                PieTitle1_R.Text = RGBWrite("R", cd.Color.R)
                PieTitle1_G.Text = RGBWrite("G", cd.Color.G)
                PieTitle1_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbPieBorder1.Checked Then
                txtColorPieBorder1.BackColor = cd.Color
                PieBorder1_R.Text = RGBWrite("R", cd.Color.R)
                PieBorder1_G.Text = RGBWrite("G", cd.Color.G)
                PieBorder1_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbPieTitle2.Checked Then
                txtColorPieTitle2.BackColor = cd.Color
                PieTitle2_R.Text = RGBWrite("R", cd.Color.R)
                PieTitle2_G.Text = RGBWrite("G", cd.Color.G)
                PieTitle2_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbPieBorder2.Checked Then
                txtColorPieBorder2.BackColor = cd.Color
                PieBorder2_R.Text = RGBWrite("R", cd.Color.R)
                PieBorder2_G.Text = RGBWrite("G", cd.Color.G)
                PieBorder2_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableHeaderTrx.Checked Then
                txtColorTableHeaderTrx.BackColor = cd.Color
                TableHeaderTrx_R.Text = RGBWrite("R", cd.Color.R)
                TableHeaderTrx_G.Text = RGBWrite("G", cd.Color.G)
                TableHeaderTrx_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableLineTrx.Checked Then
                txtColorTableLineTrx.BackColor = cd.Color
                TableLineTrx_R.Text = RGBWrite("R", cd.Color.R)
                TableLineTrx_G.Text = RGBWrite("G", cd.Color.G)
                TableLineTrx_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableItemsTrx.Checked Then
                txtColorTableItemsTrx.BackColor = cd.Color
                TableItemsTrx_R.Text = RGBWrite("R", cd.Color.R)
                TableItemsTrx_G.Text = RGBWrite("G", cd.Color.G)
                TableItemsTrx_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableTitleTrx.Checked Then
                txtColorTableTitleTrx.BackColor = cd.Color
                TableTitleTrx_R.Text = RGBWrite("R", cd.Color.R)
                TableTitleTrx_G.Text = RGBWrite("G", cd.Color.G)
                TableTitleTrx_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableHeaderHolding.Checked Then
                txtColorTableHeaderHolding.BackColor = cd.Color
                TableHeaderHolding_R.Text = RGBWrite("R", cd.Color.R)
                TableHeaderHolding_G.Text = RGBWrite("G", cd.Color.G)
                TableHeaderHolding_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableLineHolding.Checked Then
                txtColorTableLineHolding.BackColor = cd.Color
                TableLineHolding_R.Text = RGBWrite("R", cd.Color.R)
                TableLineHolding_G.Text = RGBWrite("G", cd.Color.G)
                TableLineHolding_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableItemsHolding.Checked Then
                txtColorTableItemsHolding.BackColor = cd.Color
                TableItemsHolding_R.Text = RGBWrite("R", cd.Color.R)
                TableItemsHolding_G.Text = RGBWrite("G", cd.Color.G)
                TableItemsHolding_B.Text = RGBWrite("B", cd.Color.B)
            ElseIf rbTableTitleHolding.Checked Then
                txtColorTableTitleHolding.BackColor = cd.Color
                TableTitleHolding_R.Text = RGBWrite("R", cd.Color.R)
                TableTitleHolding_G.Text = RGBWrite("G", cd.Color.G)
                TableTitleHolding_B.Text = RGBWrite("B", cd.Color.B)
            End If
        End If
    End Sub
    ...
    Private Sub rbTableHeaderTrx_Click(sender As Object, e As EventArgs) Handles rbTableHeaderTrx.Click
        colorSet()
    End Sub

    Private Sub rbTableLineTrx_Click(sender As Object, e As EventArgs) Handles rbTableLineTrx.Click
        colorSet()
    End Sub

    Private Sub rbTableItemsTrx_Click(sender As Object, e As EventArgs) Handles rbTableItemsTrx.Click
        colorSet()
    End Sub

    Private Sub rbTableTitleTrx_Click(sender As Object, e As EventArgs) Handles rbTableTitleTrx.Click
        colorSet()
    End Sub
    ...
    Private Sub rbTableLineHolding_Click(sender As Object, e As EventArgs) Handles rbTableLineHolding.Click
        colorSet()
    End Sub

    Private Sub rbTableHeaderHolding_Click(sender As Object, e As EventArgs) Handles rbTableHeaderHolding.Click
        colorSet()
    End Sub

    Private Sub rbTableItemsHolding_Click(sender As Object, e As EventArgs) Handles rbTableItemsHolding.Click
        colorSet()
    End Sub

    Private Sub rbTableTitleHolding_Click(sender As Object, e As EventArgs) Handles rbTableTitleHolding.Click
        colorSet()
    End Sub
