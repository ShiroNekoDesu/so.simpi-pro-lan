...
Public Class ReportSalesTransaction
    ...
    Dim objCapital As New TransactionSales
    ...
    Private Sub DataSearch()
        If objPortfolio.GetPortfolioID > 0 And objSales.GetSalesID > 0 Then
            objCapital.Clear()
            dtTransaction = objCapital.SalesAllSearch(objSales, objPortfolio, dtFrom.Value, dtTo.Value, "")
            SummaryClear()
    ...
    Private Sub DisplayAllDirect()
        Dim query = From u In dtTransaction.AsEnumerable
                    ...
                    Select Tanggal = u.Field(Of Date)("TrxDate"), NAVDate = u.Field(Of Date)("NAVDate"),
                           ...
                           Name = u.Field(Of String)("ClientName"),
                           ...
                           Sales = u.Field(Of String)("SalesCode")
    ...
    Private Sub DisplayTypeTeam()
        Dim query = From u In dtTransaction.AsEnumerable
                    Join s In dtParameterTATrxType1.AsEnumerable On
                          u.Field(Of Integer)("TrxType1") Equals s.Field(Of Integer)("TrxTypeID")
                    Where u.Field(Of Integer)("TrxType1") = cmbType.SelectedValue And
                          u.Field(Of String)("TreePrefix").ToUpper.StartsWith(objSales.GetTreePrefix.ToUpper) And
                          u.Field(Of Integer)("SalesID") <> objSales.GetSalesID
                    Select Tanggal = u.Field(Of Date)("TrxDate"), NAVDate = u.Field(Of Date)("NAVDate"),
                           Type = s.Field(Of String)("TrxTypeCode"),
                           Name = u.Field(Of String)("ClientName"),
    ...
    Private Sub DisplayTypeAll()
        Dim query = From u In dtTransaction.AsEnumerable
                    Join s In dtParameterTATrxType1.AsEnumerable On
                          u.Field(Of Integer)("TrxType1") Equals s.Field(Of Integer)("TrxTypeID")
                    Where u.Field(Of Integer)("TrxType1") = cmbType.SelectedValue And
                          u.Field(Of String)("TreePrefix").ToUpper.StartsWith(objSales.GetTreePrefix.ToUpper)
                    Select Tanggal = u.Field(Of Date)("TrxDate"), NAVDate = u.Field(Of Date)("NAVDate"),
                           Type = s.Field(Of String)("TrxTypeCode"),
                           Name = u.Field(Of String)("ClientName"),
                           Amount = u.Field(Of Decimal)("TrxAmount"),
