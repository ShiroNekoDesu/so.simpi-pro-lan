...
#Region "fee historical"
    ...
    Private Sub DisplayFeeCcy()
        If dtFee IsNot Nothing AndAlso dtFee.Rows.Count > 0 AndAlso
           dtPortfolioMaster IsNot Nothing AndAlso dtPortfolioMaster.Rows.Count > 0 AndAlso cmbCcy.SelectedIndex <> -1 Then
            Dim query = From f In dtFee.AsEnumerable
                        Join p In dtPortfolioMaster On f.Field(Of Integer)("PortfolioID") Equals p.Field(Of Integer)("PortfolioID")
...
#Region "summary"
    Private Sub DisplaySummaryFund()
        If dtFee IsNot Nothing AndAlso dtFee.Rows.Count > 0 AndAlso
           dtPortfolioMaster IsNot Nothing AndAlso dtPortfolioMaster.Rows.Count > 0 AndAlso objPortfolio.GetPortfolioID > 0 Then
            Dim query = From f In dtFee.AsEnumerable
                        Join p In dtPortfolioMaster On f.Field(Of Integer)("PortfolioID") Equals p.Field(Of Integer)("PortfolioID")
